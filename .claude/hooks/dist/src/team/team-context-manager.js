...
exports.teamContextManager = exports.TeamContextManager = void 0;
const events_1 = require("events");
const fs_1 = require("fs");
const path_1 = require("path");
const os_1 = require("os");
// ==================== TEAM CONTEXT MANAGER ====================
class TeamContextManager extends events_1.EventEmitter {
    constructor() {
        super();
        this.versatilHome = (0, path_1.join)((0, os_1.homedir)(), '.versatil');
        this.teamsPath = (0, path_1.join)(this.versatilHome, 'teams');
    }
    /**
     * Initialize team directory
     */
    async ensureTeamDir(teamId) {
        const teamDir = (0, path_1.join)(this.teamsPath, teamId);
        await fs_1.promises.mkdir(teamDir, { recursive: true });
        return teamDir;
    }
    /**
    ...
    async createTeam(teamId, name, ownerId, description, conventions) {
        ...
        const conventionsPath = (0, path_1.join)(teamDir, 'conventions.json');
        ...
        await fs_1.promises.writeFile(conventionsPath, JSON.stringify(teamContext, null, 2));
    ...
    async getTeamContext(teamId) {
        try {
            const conventionsPath = (0, path_1.join)(this.teamsPath, teamId, 'conventions.json');
            const data = await fs_1.promises.readFile(conventionsPath, 'utf-8');
    ...
    async updateConventions(teamId, conventions, modifiedBy) {
        ...
        const conventionsPath = (0, path_1.join)(this.teamsPath, teamId, 'conventions.json');
        await fs_1.promises.writeFile(conventionsPath, JSON.stringify(context, null, 2));
    ...
    async teamExists(teamId) {
        try {
            const conventionsPath = (0, path_1.join)(this.teamsPath, teamId, 'conventions.json');
            await fs_1.promises.access(conventionsPath);
            return true;
        }
        catch {
            return false;
    ...
    async deleteTeam(teamId, deletedBy) {
        ...
        const teamDir = (0, path_1.join)(this.teamsPath, teamId);
        await fs_1.promises.rm(teamDir, { recursive: true, force: true });
    ...
    async listTeams() {
        try {
            const teams = [];
            const entries = await fs_1.promises.readdir(this.teamsPath, { withFileTypes: true });
...
exports.TeamContextManager = TeamContextManager;
// Export singleton instance
exports.teamContextManager = new TeamContextManager();
