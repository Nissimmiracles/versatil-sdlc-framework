...
exports.RootCauseLearner = void 0;
...
class RootCauseLearner {
    ...
    async queryRAGForSimilarIssues(issueDescription) {
        ...
        try {
            const similarPatterns = await (0, guardian_learning_store_js_1.searchGuardianLearnings)(issueDescription, 5);
...
exports.RootCauseLearner = RootCauseLearner;
