...
exports.LAYER_AGENT_ROUTING = void 0;
exports.classifyIssueLayer = classifyIssueLayer;
exports.classifyIssues = classifyIssues;
exports.getLayerStatistics = getLayerStatistics;
/**
 ...
 */
function classifyIssueLayer(issue) {
    ...
    const winningLayer = Object.entries(layerVotes)
 ...
 */
function getLayerStatistics(classifications) {
    const stats = {
    ...
    for (const layer of ['framework', 'project', 'context']) {
        if (stats.by_layer[layer] > 0) {
            stats.avg_confidence[layer] = Math.round(confidenceSums[layer] / stats.by_layer[layer]);
        }
    }
    return stats;
}
