...
exports.gcpVectorStore = exports.GCPVectorStore = void 0;
const firestore_1 = require("@google-cloud/firestore");
const events_1 = require("events");
const vertex_ai_mcp_executor_js_1 = require("../mcp/vertex-ai-mcp-executor.js");
class GCPVectorStore extends events_1.EventEmitter {
    constructor() {
        super();
    ...
    async storePattern(pattern) {
        ...
        try {
            ...
            const embeddingResult = await vertex_ai_mcp_executor_js_1.vertexAIMCPExecutor.executeVertexAIMCP('embeddings', {
                texts: [embeddingText],
...
exports.GCPVectorStore = GCPVectorStore;
// Export singleton instance
exports.gcpVectorStore = new GCPVectorStore();
