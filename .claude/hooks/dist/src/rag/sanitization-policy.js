...
exports.sanitizationPolicy = exports.SanitizationPolicy = exports.StorageDestination = exports.PatternClassification = void 0;
exports.getSanitizationPolicy = getSanitizationPolicy;
const pattern_sanitizer_js_1 = require("./pattern-sanitizer.js");
...
})(PatternClassification || (exports.PatternClassification = PatternClassification = {}));
...
})(StorageDestination || (exports.StorageDestination = StorageDestination = {}));
/**
 * Sanitization Policy Engine
 */
class SanitizationPolicy {
    constructor() {
        this.sanitizer = (0, pattern_sanitizer_js_1.getPatternSanitizer)();
    }
    /**
    ...
    async evaluatePattern(pattern) {
        ...
        return {
            ...
            sanitizationRequired: sanitizationResult.level !== pattern_sanitizer_js_1.SanitizationLevel.NONE,
            sanitizationResult: sanitizationResult.level !== pattern_sanitizer_js_1.SanitizationLevel.NONE ? sanitizationResult : null,
            reasoning,
            recommendations
        };
    }
    ...
    classifyPattern(sanitizationResult, pattern) {
        switch (sanitizationResult.decision) {
            case pattern_sanitizer_js_1.SanitizationDecision.ALLOW_AS_IS:
                return PatternClassification.PUBLIC_SAFE;
            case pattern_sanitizer_js_1.SanitizationDecision.ALLOW_AFTER_SANITIZATION:
                if (sanitizationResult.level === pattern_sanitizer_js_1.SanitizationLevel.LIGHT || sanitizationResult.level === pattern_sanitizer_js_1.SanitizationLevel.MODERATE) {
            ...
            case pattern_sanitizer_js_1.SanitizationDecision.REJECT_CREDENTIALS:
                return PatternClassification.CREDENTIALS;
            case pattern_sanitizer_js_1.SanitizationDecision.REJECT_BUSINESS_LOGIC:
                return PatternClassification.PRIVATE_ONLY;
            case pattern_sanitizer_js_1.SanitizationDecision.REJECT_UNSANITIZABLE:
                return PatternClassification.UNSANITIZABLE;
            default:
                return PatternClassification.PRIVATE_ONLY;
        }
...
exports.SanitizationPolicy = SanitizationPolicy;
...
exports.sanitizationPolicy = getSanitizationPolicy();
