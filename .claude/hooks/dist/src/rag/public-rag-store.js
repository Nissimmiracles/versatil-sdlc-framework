...
exports.publicRAGStore = exports.PublicRAGStore = void 0;
...
const privacy_auditor_js_1 = require("./privacy-auditor.js");
/**
 * Public RAG Store - Framework patterns only
 */
class PublicRAGStore extends graphrag_store_js_1.GraphRAGStore {
    constructor() {
        super();
        ...
        this.sanitizationPolicy = (0, sanitization_policy_js_1.getSanitizationPolicy)();
        this.privacyAuditor = (0, privacy_auditor_js_1.getPrivacyAuditor)();
    }
    /**
     * Singleton instance
     */
    ...
    async addPattern(pattern) {
        ...
        switch (policyDecision.classification) {
            case sanitization_policy_js_1.PatternClassification.CREDENTIALS:
            ...
            case sanitization_policy_js_1.PatternClassification.PRIVATE_ONLY:
                throw new Error(`❌ REJECTED: Pattern is proprietary/confidential\n` +
                    `   Pattern: "${pattern.pattern}"\n` +
                    `   Reason: ${policyDecision.reasoning.join('\n   ')}\n` +
                    `   Action: Store in Private RAG only (NOT Public RAG)\n` +
                    `   Configure Private RAG: npm run setup:private-rag`);
            case sanitization_policy_js_1.PatternClassification.UNSANITIZABLE:
                throw new Error(`❌ REJECTED: Pattern is too project-specific\n` +
                    ...
                    `   Configure Private RAG: npm run setup:private-rag`);
            case sanitization_policy_js_1.PatternClassification.REQUIRES_SANITIZATION:
                ...
                break;
            case sanitization_policy_js_1.PatternClassification.PUBLIC_SAFE:
        ...
        return super.addPattern({
            ...
            privacy: {
                isPublic: true,
                sanitized: policyDecision.classification === sanitization_policy_js_1.PatternClassification.REQUIRES_SANITIZATION,
...
exports.PublicRAGStore = PublicRAGStore;
// Export singleton instance
exports.publicRAGStore = PublicRAGStore.getInstance();
