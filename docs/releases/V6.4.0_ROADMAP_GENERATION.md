...
2. **Recommends specific agents** from the 17 available (8 core + 10 sub-agents)
...
**User Intent**:
- Update installation documentation for v6.4.0 (18 agents)
...
1. Updated "Core Capabilities" section:
   - Changed from "6 OPERA Agents" to "18 OPERA agents (v6.4.0)"
   - Listed 8 core agents + 10 sub-agents
...
2. Added "Automatic Roadmap Generation" section:
   ...
   2. Recommends agents (selects from 18 agents based on tech stack)
...
2. `README.md`:
   - Updated "Core Capabilities" (18 agents instead of 6)
...
- [.claude/AGENTS.md](../../.claude/AGENTS.md) - 18 agents documented
