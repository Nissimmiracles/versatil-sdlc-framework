 ...
 */
export const DEFAULT_CAG_CONFIG = {
    global: {
        enabled: true,
...
export function loadCAGConfig() {
    ...
    if (process.env.CAG_STRATEGY) {
        const strategy = process.env.CAG_STRATEGY;
 ...
 */
export function getAgentCAGConfig(agentId) {
 ...
 */
export function validateCAGConfig(config) {
    const errors = [];
...
//# sourceMappingURL=cag-config.js.map