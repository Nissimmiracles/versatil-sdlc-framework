...
export var ScenarioCategory;
(function (ScenarioCategory) {
    ScenarioCategory["DEVELOPMENT"] = "development";
    ScenarioCategory["EMERGENCY"] = "emergency";
    ScenarioCategory["QUALITY"] = "quality";
    ScenarioCategory["ONBOARDING"] = "onboarding";
    ScenarioCategory["SECURITY"] = "security";
    ScenarioCategory["PERFORMANCE"] = "performance";
    ScenarioCategory["DEPLOYMENT"] = "deployment";
    ScenarioCategory["INTEGRATION"] = "integration";
})(ScenarioCategory || (ScenarioCategory = {}));
export var ScenarioComplexity;
(function (ScenarioComplexity) {
    ScenarioComplexity["LOW"] = "low";
    ScenarioComplexity["MEDIUM"] = "medium";
    ScenarioComplexity["HIGH"] = "high";
    ScenarioComplexity["CRITICAL"] = "critical";
})(ScenarioComplexity || (ScenarioComplexity = {}));
export var OutcomeType;
(function (OutcomeType) {
    OutcomeType["PERFORMANCE"] = "performance";
    OutcomeType["QUALITY"] = "quality";
    OutcomeType["INTELLIGENCE"] = "intelligence";
    OutcomeType["COLLABORATION"] = "collaboration";
    OutcomeType["AUTOMATION"] = "automation";
...
export class MultiAgentScenarioRunner {
     ...
     */
    createScenario1_FullStackDevelopment() {
        return {
...
`
     ...
     */
    createScenario2_PerformanceCrisis() {
        return {
     ...
     */
    createScenario3_DailyHealthAudit() {
        return {
     ...
     */
    createScenario4_MultiFileRefactoring() {
        return {
     ...
     */
    createScenario5_NewDeveloperOnboarding() {
        return {
     ...
     */
    createScenario6_SecurityVulnerability() {
        return {
    ...
    createScenario7_MLModelDeployment() {
        return {
    ...
    createScenario8_APIIntegrationStress() {
        return {
    ...
    createScenario9_VisualRegressionDetection() {
        return {
    ...
    createScenario10_MultiServiceOrchestration() {
        return {
     ...
     */
    evaluateOutcomes(scenario, result) {
        const outcomes = [];
     ...
     */
    calculateAverageHandoffLatency() {
     ...
     */
    identifyIssues(scenario, result) {
        const issues = [];
     ...
     */
    identifyEnhancements(scenario, result) {
        const enhancements = [];
    ...
    generateComprehensiveReport(results) {
        ...
        const sortedEnhancements = allEnhancements.sort((a, b) => priorityOrder[a.priority] - priorityOrder[b.priority]);
...
//# sourceMappingURL=multi-agent-scenario-runner.js.map