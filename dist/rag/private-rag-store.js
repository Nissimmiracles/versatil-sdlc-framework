...
export class PrivateRAGStore extends GraphRAGStore {
    ...
    initializeSupabase() {
        ...
        this.supabaseClient = createClient(this.config.supabase.url, this.config.supabase.anonKey);
...
export function getPrivateRAGStore(config) {
...
//# sourceMappingURL=private-rag-store.js.map