...
export class TodoFileGenerator {
    ...
    async generateTodos(specs) {
        ...
        const todoNumberMap = new Map(); // index -> number
     ...
     */
    generateFileName(todoNumber, spec) {
     ...
     */
    populateTemplate(template, spec, todoNumber) {
     ...
     */
    generateDependencyGraph(specs, numberMap) {
     ...
     */
    detectExecutionWaves(specs, numberMap) {
        const waves = [];
...
//# sourceMappingURL=todo-file-generator.js.map