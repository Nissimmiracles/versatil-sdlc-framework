 ...
 */
export async function detectContextIdentity(workingDir) {
...
async function isFrameworkDevelopment(workingDir) {
    try {
        ...
        const hasMarkers = frameworkMarkers.every(marker => existsSync(join(workingDir, marker)));
        if (hasMarkers) {
            return true;
        }
 ...
 */
export function validateAccess(identity, targetPath) {
    // Check if blocked
 ...
 */
export function validateAgent(identity, agentName) {
...
//# sourceMappingURL=context-identity.js.map