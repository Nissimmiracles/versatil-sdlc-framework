...
import { getUsageLogger } from './usage-logger.js';
export class SessionManager {
    constructor() {
        this.usageLogger = getUsageLogger();
    ...
    async getAllSessions() {
        try {
            ...
            const summaries = await Promise.all(sessionFiles.map(async (file) => {
