...
export class UpdateValidator {
     ...
     */
    async comparePerformance(before, after) {
        const improvements = [];
        const regressions = [];
        // Startup time
     ...
     */
    async checkCommandAvailability() {
        try {
     ...
     */
    async testFeature(name, command) {
        try {
            ...
            return {
                feature: name,
                working: false,
                message: `❌ ${name} command failed: ${error.message}`
            };
        }
    }
    /**
