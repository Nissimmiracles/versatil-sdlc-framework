...
`;
     ...
     */
    async triggerPercySnapshot(context) {
     ...
     */
    determinePercyTest(filePath, content) {
     ...
     */
    addPercyRecommendation(response, testCommand) {
        response.suggestions = response.suggestions || [];
        response.suggestions.push({
     ...
     */
    async activateWithVisualTesting(context) {
     ...
     */
    async validatePercyResults(percyBuildId) {
