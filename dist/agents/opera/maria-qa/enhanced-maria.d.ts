...
export declare class EnhancedMaria extends RAGEnabledAgent {
     ...
     */
    triggerPercySnapshot(context: AgentActivationContext): Promise<boolean>;
    /**
     ...
     */
    activateWithVisualTesting(context: AgentActivationContext): Promise<AgentResponse>;
    /**
     * Validate Percy results (called from CI/CD)
     */
    validatePercyResults(percyBuildId: string): Promise<{
        passed: boolean;
