...
export class JamesSvelte extends EnhancedJames {
    constructor(vectorStore) {
        super(vectorStore);
        this.name = 'James-Svelte';
        this.id = 'james-svelte';
        this.specialization = 'Svelte 4/5 Frontend Specialist';
        this.systemPrompt = `You are James-Svelte, a specialized Svelte 4/5 expert with deep knowledge of:
...
- Testing with Vitest and Testing Library`;
     ...
     */
    async analyzeSveltePatterns(context) {
     ...
     * Check for improper reactive statements
     */
    hasImproperReactiveStatements(content) {
     ...
     */
    hasMissingStoreCleanup(content) {
     ...
     * Check for direct store mutation
     */
    hasDirectStoreMutation(content) {
     ...
     */
    hasImproperPropBinding(content) {
     ...
     * Check for unused reactive statements
     */
    hasUnusedReactiveStatements(content) {
     ...
     */
    generateSvelteRecommendations(content) {
