...
export class JamesSDKAgent extends SDKAgentAdapter {
     ...
     * }
     */
    shouldTriggerUXReview(filePaths) {
        ...
        return filePaths.some(path => uxRelevantExtensions.some(ext => path.endsWith(ext)));
    }
}
//# sourceMappingURL=james-sdk-agent.js.map