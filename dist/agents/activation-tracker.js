...
export class ActivationTracker extends EventEmitter {
     ...
     */
    generateSummary(accuracy, latency, failedAgents, slowAgents) {
        const parts = [];
        // Accuracy assessment
        if (accuracy >= 95) {
     ...
     * Get events by agent
     */
    getEventsByAgent(agentId, limit) {
 ...
 */
export function getActivationTracker() {
    if (!globalTracker) {
 ...
 */
export function resetActivationTracker() {
    if (globalTracker) {
        globalTracker.shutdown();
        globalTracker = null;
    }
}
//# sourceMappingURL=activation-tracker.js.map