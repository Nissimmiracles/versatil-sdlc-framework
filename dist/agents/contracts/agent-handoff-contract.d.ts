 ...
 */
export type HandoffType = 'sequential' | 'parallel' | 'aggregation' | 'broadcast' | 'conditional';
/**
 ...
 */
export type HandoffStatus = 'pending' | 'in_transit' | 'accepted' | 'rejected' | 'completed' | 'failed' | 'cancelled';
/**
