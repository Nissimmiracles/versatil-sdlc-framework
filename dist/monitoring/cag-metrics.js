...
export class CAGMetricsTracker extends EventEmitter {
    constructor() {
        super();
        this.timeSeries = [];
        this.maxTimeSeriesPoints = 1440; // 24 hours at 1 min intervals
        // Daily cost tracking
        this.dailyCosts = new Map(); // date -> cost
        this.dailyQueries = new Map(); // date -> query count
...
//# sourceMappingURL=cag-metrics.js.map