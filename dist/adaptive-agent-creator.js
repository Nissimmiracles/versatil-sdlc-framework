...
export class AdaptiveAgentCreator {
     ...
     */
    async analyzeProjectNeeds(projectPath) {
     ...
     */
    async createAgentIfNeeded(trigger) {
     ...
     */
    async evaluatePatternForAgentCreation(pattern) {
...
//# sourceMappingURL=adaptive-agent-creator.js.map