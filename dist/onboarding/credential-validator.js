 ...
 */
export function validateServiceCredentials(service, credentials) {
 ...
 */
async function testVertexAIConnection(credentials) {
 ...
 */
async function testSentryConnection(credentials) {
    const startTime = Date.now();
    try {
 ...
 */
async function testExaConnection(credentials) {
    const startTime = Date.now();
    try {
 ...
 */
async function testN8nConnection(credentials) {
    const startTime = Date.now();
    try {
 ...
 */
async function testOpenAIConnection(credentials) {
    const startTime = Date.now();
    try {
 ...
 */
async function testSemgrepConnection(credentials) {
    const startTime = Date.now();
    try {
 ...
 */
export async function testServiceConnection(serviceId, credentials) {
    switch (serviceId) {
        case 'vertex-ai':
 ...
 */
export async function testAllConnections(allCredentials) {
    const results = [];
