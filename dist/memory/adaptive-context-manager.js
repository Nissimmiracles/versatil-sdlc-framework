...
export class AdaptiveContextManager {
    constructor(statsTracker, config) {
        ...
        this.DEFAULT_THRESHOLD = 30000; // Claude recommended
        this.MIN_THRESHOLD = 15000; // Too low = excessive clears
        this.MAX_THRESHOLD = 100000; // Too high = cache invalidation
        this.TARGET_CACHE_RATE = 0.70; // 70%+ is excellent
        this.AGGRESSIVE_FACTOR = 0.85; // 15% reduction for long convos
        this.CONSERVATIVE_FACTOR = 1.15; // 15% increase for high cache rate
