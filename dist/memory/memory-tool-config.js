 ...
 */
export const AGENT_MEMORY_TEMPLATES = {
    'maria-qa': [
        {
 ...
 */
export function getMemoryFilePath(agentId, filename) {
 ...
 */
export function updateContextClearThreshold(newThreshold) {
    // Validate threshold is within safe bounds
    const MIN_THRESHOLD = 15000;
 ...
 */
export function getContextClearThreshold() {
    return MEMORY_TOOL_CONFIG.contextManagement.edits[0].trigger.value;
}
//# sourceMappingURL=memory-tool-config.js.map