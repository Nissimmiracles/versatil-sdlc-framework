...
export class MCPToolManager {
     ...
     */
    async executeMCPTool(tool, context) {
        const result = {
            success: false,
            tool,
     ...
     */
    async executeChromeMCP(context) {
     ...
     */
    async executePlaywrightMCP(context) {
     ...
     */
    async executeShadcnMCP(context) {
        try {
     ...
     */
    async executeGitHubMCP(context) {
        try {
     ...
     */
    async callMCPFunction(functionName, params) {
     ...
     */
    extractComponentFromContext(context) {
        const filePath = context.filePath || '';
        if (filePath.includes('Button'))
            return 'VERSSAIButton';
     ...
     */
    async executeVertexAIMCP(context) {
        try {
     ...
     */
    async executeSupabaseMCP(context) {
        try {
     ...
     */
    async executeSemgrepMCP(context) {
        try {
     ...
     */
    async executeSentryMCP(context) {
        try {
