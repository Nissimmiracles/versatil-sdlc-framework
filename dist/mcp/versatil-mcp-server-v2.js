...
let shadcnMCPExecutor = null; // Lazy init with projectPath
...
export class VERSATILMCPServerV2 {
    constructor(config) {
        ...
        this.eventCallbacks = new Map(); // eslint-disable-line @typescript-eslint/no-unsafe-function-type
