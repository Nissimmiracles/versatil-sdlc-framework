...
import { getConsoleErrorMonitor } from '../agents/opera/maria-qa/console-error-monitor.js';
import { getNetworkRequestTracker } from '../agents/opera/maria-qa/network-request-tracker.js';
export class ChromeMCPExecutor {
    constructor(config = {}) {
        this.browser = null;
        this.context = null;
        this.activeSessions = new Map();
        this.consoleMonitor = getConsoleErrorMonitor();
        this.networkTracker = getNetworkRequestTracker();
