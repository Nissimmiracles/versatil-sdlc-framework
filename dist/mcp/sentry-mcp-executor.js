...
export class SentryMCPExecutor {
     ...
     */
    async executeSentryMCP(action, params = {}) {
        try {
            switch (action) {
                case 'fetch_issue':
     ...
     */
    async triggerSeerAnalysis(params) {
     ...
     */
    async getStackTraceFromIssue(issueId) {
        try {
            ...
            if (event.exception && event.exception.values && event.exception.values[0]) {
                ...
                if (exception.stacktrace && exception.stacktrace.frames) {
                    return exception.stacktrace.frames.map((frame) => ({
...
//# sourceMappingURL=sentry-mcp-executor.js.map