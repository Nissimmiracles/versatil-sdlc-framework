...
export class SemgrepMCPExecutor {
     ...
     */
    async executeSemgrepMCP(action, params = {}) {
        try {
            switch (action) {
                case 'security_check':
    ...
    async securityCheck(params) {
        ...
        try {
            ...
            const findings = await this.runSemgrepScan(code, language, filePath);
     ...
     */
    async scanWithCustomRule(params) {
     ...
     */
    async getSemgrepFindings(params = {}) {
     ...
     */
    async runSemgrepScan(code, language, filePath) {
     ...
     */
    patternBasedScan(code, language) {
        const findings = [];
...
//# sourceMappingURL=semgrep-mcp-executor.js.map