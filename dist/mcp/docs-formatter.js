...
export class DocsFormatter {
     ...
     */
    static formatAgentDocs(agentId, content) {
     ...
     */
    static formatWorkflowDocs(workflowType, content) {
        const sections = this.extractSections(content);
        const doc = {
            workflowType,
     ...
     */
    static extractAgentName(content, agentId) {
     ...
     */
    static extractAgentRole(content) {
     ...
     */
    static extractWorkflowName(content, workflowType) {
     ...
     */
    static extractList(content, headingKeywords) {
        const items = [];
     ...
     */
    static extractFilePatterns(content) {
        const patterns = [];
     ...
     */
    static extractWorkflowPhases(content) {
        const phases = [];
     ...
     */
    static extractTimeSavings(content) {
...
//# sourceMappingURL=docs-formatter.js.map