...
export class VERSATILMCPClient {
    ...
    async handleQualityGate(args) {
        ...
        qualityResult.checkResults = checks.map((check) => ({
            check,
            status: 'passed',
     ...
     */
    async handleArchitectureAnalysis(args) {
     ...
     */
    async handleAdaptiveInsights(args) {
