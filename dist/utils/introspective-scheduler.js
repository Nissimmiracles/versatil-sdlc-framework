...
export class IntrospectiveScheduler extends EventEmitter {
     ...
     */
    async executeIntrospection(force = false) {
        ...
        try {
            ...
            if (result && typeof result === 'object' && 'context' in result) {
                improvements = result.context?.optimizationsApplied || 0;
            }
            success = true;
            ...
            this.logger.info('✅ Scheduled introspection completed', {
                ...
                improvements,
                confidence: result && typeof result === 'object' && 'context' in result ? result.context?.confidence || 0 : 0
            }, 'IntrospectiveScheduler');
     ...
     */
    calculateAverageExecutionTime(newExecutionTime) {
...
export function createIntrospectiveScheduler(agent, config) {
    return new IntrospectiveScheduler(agent, config);
}
//# sourceMappingURL=introspective-scheduler.js.map