...
export class ZeroTrustProjectIsolation extends EventEmitter {
    ...
    async createProjectIsolation(projectId, projectPath, projectType = 'standard') {
    ...
    async enforcePhysicalBoundaries(projectId, projectPath) {
...
`;
    ...
    async enforceLogicalBoundaries(projectId, boundary) {
    ...
    startProjectMonitoring(projectId, boundary) {
    ...
    async verifyProjectBoundary(projectId, boundary) {
    ...
    async executeVerificationCheck(projectId, check) {
    ...
    async checkFileSystemIntegrity(projectId, projectPath) {
    ...
    async checkCrossProjectAccess(projectId) {
    ...
    async checkPrivilegeEscalation(projectId) {
    ...
    async checkConfigurationIntegrity(projectId, projectPath) {
    ...
    async executeFailureAction(projectId, action, result) {
        switch (action) {
            case 'log':
    ...
    async blockProjectAccess(projectId, reason) {
    ...
    async handleCompromisedBoundary(projectId, boundary, verificationResults) {
    ...
    async enhanceProjectMonitoring(projectId) {
    ...
    async verifyAllBoundaryIntegrity() {
    ...
    async scanProjectForThreats(projectId) {
    ...
    async evaluateThreatRule(projectId, rule) {
    ...
    async handleThreatDetection(projectId, rule, result) {
    ...
    async executeThreatResponse(projectId, action, threatResult) {
    ...
    async validateProjectAccess(projectId, operation, targetPath) {
    ...
    getProjectBoundary(projectId) {
        return this.boundaries.get(projectId);
    }
    getAllProjectBoundaries() {
        return Array.from(this.boundaries.values());
    }
    async removeProjectIsolation(projectId) {
        // Stop monitoring
        const monitoring = this.activeMonitoring.get(projectId);
        if (monitoring) {
            clearInterval(monitoring);
...
//# sourceMappingURL=zero-trust-project-isolation.js.map