...
export class CredentialEncryptor {
     ...
     */
    deriveEncryptionKey(context, salt, password) {
     ...
     */
    async encrypt(credentials, context, password) {
        try {
     ...
     */
    async decrypt(encrypted, context, password) {
        try {
     ...
     */
    async encryptToFile(credentials, filePath, context, password) {
        try {
     ...
     */
    async decryptFromFile(filePath, context, password) {
        try {
     ...
     */
    async validateCredentialsFile(filePath) {
        try {
            const content = await fs.readFile(filePath, 'utf8');
            const encrypted = JSON.parse(content);
     ...
     */
    async reencryptWithPassword(filePath, context, newPassword) {
        try {
