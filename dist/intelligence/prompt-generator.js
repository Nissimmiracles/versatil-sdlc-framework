...
export class PromptGenerator {
     ...
     */
    static generateQAPrompt(context) {
...
`;
     ...
     */
    static generateFrontendPrompt(context) {
        const { filePath, content, analysisResult } = context;
        const prompt = `---
...
`;
     ...
     */
    static generateBackendPrompt(context) {
        const { filePath, content, analysisResult } = context;
...
`;
     ...
     */
    static generatePMPrompt(context) {
...
`;
     ...
     */
    static generatePrompt(agent, context) {
        switch (agent) {
            case 'enhanced-maria':
            case 'maria-qa':
     ...
     */
    static generateRAGContextSection(ragContext) {
        if (!ragContext)
            return '';
