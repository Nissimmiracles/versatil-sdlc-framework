...
class FrameworkIntegrationTester {
    ...
    async testAgentPatternMatching() {
        try {
    ...
    async testAgentActivationPipeline() {
        try {
    ...
    async testClarificationGeneration() {
        try {
    ...
    async testAgentRecommendation() {
        try {
            ...
            const correctRecommendations = frontendResult.recommendedAgents.some(a => a.includes('James')) &&
    ...
    async testEmergencyClassification() {
        try {
    ...
    async testEmergencyAgentCascade() {
        try {
    ...
    async testEmergencyMCPActivation() {
        try {
    ...
    async testEmergencyResolutionWorkflow() {
        try {
    ...
    async testAgentInvocationBridge() {
        try {
    ...
    async testCompleteDevelopmentWorkflow() {
        try {
            ...
            const workflowCompleted = contextResult.overall === 'clear' &&
    ...
    async testFrameworkEffectiveness() {
        try {
    ...
    async testRealWorldScenario() {
        try {
            ...
            const correctAgentsActivated = emergencyResponse.activatedAgents.some(a => a.includes('James')) && // Frontend
...
//# sourceMappingURL=framework-integration-tester.js.map