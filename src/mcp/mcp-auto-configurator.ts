...
export class MCPAutoConfigurator {
   ...
   */
  async detectInstallations(): Promise<DetectionResult> {
   ...
   */
  async configureClaude(projectPath: string): Promise<ConfigurationResult> {
   ...
   */
  async configureCursor(projectPath: string): Promise<ConfigurationResult> {
    const detection = await this.detectInstallations();
   ...
   */
  async autoConfigureAll(projectPath?: string): Promise<void> {
   ...
   */
  private printManualInstructions(projectPath: string): void {
   ...
   */
  private printAvailableTools(): void {
