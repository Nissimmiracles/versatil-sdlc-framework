...
class AssessmentEngine {
    constructor(workingDir, configPath) {
        ...
        const defaultConfigPath = (0, path_1.join)(workingDir, '.versatil/verification/assessment-config.json');
        const finalConfigPath = configPath || defaultConfigPath;
        if ((0, fs_1.existsSync)(finalConfigPath)) {
            this.config = JSON.parse((0, fs_1.readFileSync)(finalConfigPath, 'utf-8'));
        }
        else {
...
// EXPORTS
// ============================================================================
exports.default = AssessmentEngine;
