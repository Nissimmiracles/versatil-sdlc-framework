...
export class AutoRemediationEngine {
  private static instance: AutoRemediationEngine | null = null;
  private logger: GuardianLogger;
  private scenarios: RemediationScenario[] = [];
  ...
  public static getInstance(): AutoRemediationEngine {
  ...
  private registerScenarios(): void {
    ...
    this.registerScenario({
      ...
      auto_fixable: true,
      matcher: (issue) =>
        issue.context === 'FRAMEWORK_CONTEXT' &&
    ...
    this.registerScenario({
      ...
      execute: async (issue, projectRoot) => {
        ...
        try {
          ...
          fs.writeFileSync(
            path.join(projectRoot, '.versatil-project.json'),
   ...
   */
  private registerScenario(scenario: RemediationScenario): void {
   ...
   */
  public async remediate(issue: RemediationIssue, projectRoot: string): Promise<RemediationResult> {
   ...
   */
  public getScenarios(): RemediationScenario[] {
   ...
   */
  public getScenariosByContext(context: RemediationContext): RemediationScenario[] {
