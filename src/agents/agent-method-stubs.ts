...
export const AgentMethodStubs = {
  ...
  validateContextFlow(context: any): boolean {
    ...
    if (context.content === null || context.content === undefined) return false;
  ...
  validateNavigationIntegrity(context: any): boolean {
    ...
    if (content.includes('href="#"') || content.includes('href=""')) return false;
    if (content.includes('onClick') && !content.includes('href')) return false; // Button disguised as link
    return true;
  },
